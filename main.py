...
root = Tk()
root.title("Bekmyrza photo editor")
...
# create buttons
btn1 = Button(root, text="Choose image", bg='orange', fg='white', font=('roboto 15 bold'), relief=GROOVE, command=selected)
btn1.place(x=100, y=595)
btn2 = Button(root, text="Save", width=12, bg='green', fg='white', font=('roboto 15 bold'), relief=GROOVE, command=save)
btn2.place(x=280, y=595)
btn3 = Button(root, text="Exit", width=12, bg='red', fg='white', font=('roboto 15 bold'), relief=GROOVE,
